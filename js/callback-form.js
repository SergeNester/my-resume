...
const recievedRequestModal = document.querySelector('#recieved-request')
...
callbackForm.addEventListener('submit', function (event) {
    ...
    recievedRequestModal.classList.add('modal-active');
    userName.classList.add('callback-form-input-error');
    setTimeout(function () {
        recievedRequestModal.classList.remove('modal-active')
    }, 2000);
});
